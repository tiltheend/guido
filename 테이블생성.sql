...
ALTER TABLE "THEME" ADD "THEME_IMG" VARCHAR2(500);
COMMENT ON COLUMN "THEME"."THEME_IMG" IS '테마 이미지 URL';


ALTER TABLE RESERVATION MODIFY RESERVATION_DT NUMBER;
ALTER TABLE RESERVATION RENAME COLUMN RESERVATION_DT TO PRODUCT_DT_NO;

ALTER TABLE "RESERVATION" ADD CONSTRAINT "FK_PRODUCT_DT_TO_RESERVATION_1" FOREIGN KEY (
	"PRODUCT_DT_NO"
)
