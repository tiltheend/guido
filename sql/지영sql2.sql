...
END;
--
DELETE FROM "GUIDE" WHERE USER_NO = 60;
DELETE FROM "TOURIST" WHERE USER_NO = 48;
DELETE FROM "USER" WHERE USER_NO = 60;

DELETE FROM "USER" WHERE USER_NO = 35;
...
UPDATE "TOURIST" SET COUNTRY_CODE = 'us' WHERE USER_NO = 42;
ROLLBACK;
