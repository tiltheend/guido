...
UPDATE TOURIST
SET FACE_IMG='/images/faceImage/nisi.jpg'
WHERE USER_NO=25;
...
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 18, '아쿠아플라넷 여수', 1, '34.7462208797333', '127.748733971081', 'Y');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 18, '여수해상케이블카', 2, '34.7405016288507', '127.752958495998', 'N');
...
INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 19, '더베이101', 1, '35.1569405202022', '129.15258291771', 'N');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 19, '해운대 해수욕장', 2, '35.1585232170784', '129.159854668484', 'N');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 19, '광안어패류시장', 3, '35.1555848928379', '129.124533200856', 'Y');
...
INSERT INTO "PRODUCT_OPTION" VALUES(SEQ_OPTION_NO.NEXTVAL, '13:00',30, 19, 39);
...
INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 21, '김녕해수욕장', 1, '33.5574388587079', '126.759313988844', 'N');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 21, '김녕미로공원', 2, '33.5365318809526', '126.772235329263', 'N');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 21, '만장굴', 3, '33.5279325219862', '126.769351306065', 'Y');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 21, '비자림', 4, '33.4904083697986', '126.80998754971', 'N');
...
UPDATE PRODUCT_OPTION
SET PRODUCT_DT_NO=40
WHERE OPTION_NO=6;
COMMIT;

INSERT INTO "PRODUCT_OPTION" VALUES(SEQ_OPTION_NO.NEXTVAL, '09:00',20, 21, 43);
INSERT INTO "PRODUCT_OPTION" VALUES(옵션 번호, 시간, 최대 인원 수, 상품 번호, 상품 날짜 번호);
...
INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 22, '양떼목장', 1, '33.4109798207631', '126.3654581868727', 'Y');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 22, '아르떼뮤지엄', 2, '33.3966984960157', '126.344976221896', 'N');

INSERT INTO TOUR_COURSE
(COURSE_NO, PRODUCT_NO, COURSE_NAME, COURSE_ORDER, LATITUDE, LONGITUDE, BOSS_COURSE_FL)
VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 22, '신라스테이 제주', 3, '33.4855377018546', '126.490901912605', 'N');
...
INSERT INTO "PRODUCT_OPTION" VALUES(SEQ_OPTION_NO.NEXTVAL, '14:00',20, 22, 47);
...
VALUES(SEQ_REVIEW_NO.NEXTVAL, 26, '대박 리뷰~~', 5, 'N', 18, SYSDATE);
...
INSERT INTO REVIEW
(REVIEW_NO, USER_NO, REVIEW_MESSAGE, REVIEW_STARS, REVIEW_DEL_FL, PRODUCT_NO, CREATE_DT)
VALUES(SEQ_REVIEW_NO.NEXTVAL, 26, '가이드가 너무 친절했습니다. 여행 코스도 완벽했어요.', 4.0, 'N', 19, SYSDATE);
...
-- 1박 상품 옵션
SELECT OPTION_NO, OPTION_NAME, OPTION_REST, PRODUCT_NO, PRODUCT_DT_NO 
FROM PRODUCT_OPTION;
