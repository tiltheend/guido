...
CREATE TABLE "PRODUCT" (
	...
	"PRODUCT_STATE"	CHAR(1)	DEFAULT 'N'	NOT NULL CONSTRAINT PRODUCT_STATE_CHK CHECK(PRODUCT_STATE IN('N','B','D','E')),
...
COMMENT ON COLUMN "PRODUCT"."PRODUCT_STATE" IS '게시글 상태 (N: 정상, E: 판매완료, B : 블라인드, D: 삭제)';
...
CREATE TABLE "QNA" (
	...
	"QNA_CONTENT"	NVARCHAR2(1000)		NOT NULL,
	...
	"USER_NO"	NUMBER		NULL,
	"QNA_ANSWER"	NVARCHAR2(1000)	NULL
);
...
CREATE TABLE "RESERVATION" (
	...
	"OPTION_NO"	NUMBER,
	"REQUEST_CONTENT"	NVARCHAR2(600)		NULL,
	"ORDER_NUMBER"	CHAR(15)		NOT NULL,
	"TOTAL_PRICE"	NUMBER NOT NULL,
	"IMP_UID"	VARCHAR2(30)  NOT NULL,
	"CANCEL_REASON"	NVARCHAR2(180)		NULL
);
...
COMMENT ON COLUMN "RESERVATION"."IMP_UID" IS '거래 아임포트 고유번호';

COMMENT ON COLUMN "RESERVATION"."CANCEL_REASON" IS '취소 시 사유';
...
COMMENT ON COLUMN "PRODUCT_OPTION"."PRODUCT_DT_NO" IS '상품 일정 번호(SEQ_PRODUCT_DT_NO)';
...
ALTER TABLE "PRODUCT_OPTION" ADD CONSTRAINT "FK_PRODUCT_DT_TO_PRODUCT_OPTION_1" FOREIGN KEY (
	"PRODUCT_DT_NO"
)
REFERENCES "PRODUCT_DT" (
	"PRODUCT_DT_NO"
);
...
ALTER TABLE "PRODUCT_OPTION" ADD "PRODUCT_DT_NO" NUMBER;

COMMENT ON COLUMN "PRODUCT_OPTION"."PRODUCT_DT_NO" IS '상품 일정 번호(SEQ_PRODUCT_DT_NO)';


-- 기존 컬럼 타입 수정
ALTER TABLE "QNA" ADD "QNA_TITLE2" NVARCHAR2(100);
UPDATE "QNA" SET "QNA_TITLE2" = "QNA_TITLE";
ALTER TABLE "QNA" DROP COLUMN "QNA_TITLE";
ALTER TABLE "QNA" RENAME COLUMN "QNA_TITLE2" TO "QNA_TITLE";

ALTER TABLE "QNA" ADD "QNA_CONTENT2" NVARCHAR2(1000);
UPDATE "QNA" SET "QNA_CONTENT2" = "QNA_CONTENT";
ALTER TABLE "QNA" DROP COLUMN "QNA_CONTENT";
ALTER TABLE "QNA" RENAME COLUMN "QNA_CONTENT2" TO "QNA_CONTENT";

ALTER TABLE "QNA" ADD "QNA_ANSWER2"	NVARCHAR2(1000);
UPDATE "QNA" SET "QNA_ANSWER2" = "QNA_ANSWER";
ALTER TABLE "QNA" DROP COLUMN "QNA_ANSWER";
ALTER TABLE "QNA" RENAME COLUMN "QNA_ANSWER2" TO "QNA_ANSWER";
