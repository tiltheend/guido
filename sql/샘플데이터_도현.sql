...
UPDATE TOURIST SET COUNTRY_CODE = 'US' WHERE USER_NO=29;

COMMIT;
SELECT * FROM PRODUCT ORDER BY 1;
SELECT * FROM TOUR_COURSE TC ORDER BY 1;
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 28, '서울숲', 1, 37.544299704811976, 127.0376188794117, 'Y');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 25, '점촌점빵길', 1, 37.544299704811976, 127.0376188794117, 'Y');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 25, '김룡사', 2, 36.739322843640196, 128.22327821100342, 'N');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 25, '고모산성', 3, 36.66116544560626, 128.1272750771481, 'N');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 25, '문경새재', 4, 36.761884242060916, 128.07657669726012, 'N');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 26, '희방사', 1, 36.919558543655334, 128.4571578892506, 'Y');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 26, '부석사', 2, 36.9979823765965, 128.68655127759052, 'N');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 26, '무섬마을', 3, 36.731853808770516, 128.62158422174036, 'N');
INSERT INTO TOUR_COURSE VALUES(SEQ_TOURCOURSE_NO.NEXTVAL, 27, '남한산성', 1, 37.479015005181026, 127.18128275396325, 'Y');
COMMIT;

SELECT * FROM "USER" WHERE USER_TYPE='G';

UPDATE "USER" SET USER_STATE='Y' WHERE USER_TYPE='G';
COMMIT;