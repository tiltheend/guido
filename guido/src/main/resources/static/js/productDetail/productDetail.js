...
if (document.querySelector('.detail--right__price-total') != null) {
  ...
  priceBtn.forEach((btn) => {
    btn.addEventListener('click', () => {
      const count = Number(
        document.querySelector('.detail--right__price-count').innerText
      );
      ...
      /* 1박 이상 패키지 
            ...
            */
      if (package != 0) {
        document.getElementById('eachCost').innerText = Math.ceil(
...
window.addEventListener('scroll', () => {
  ...
  const section1 =
    scroll + document.getElementById('section1').getBoundingClientRect().top;
  const section2 =
    scroll + document.getElementById('section2').getBoundingClientRect().top;
  const section3 =
    scroll + document.getElementById('section3').getBoundingClientRect().top;
  const section4 =
    scroll + document.getElementById('section4').getBoundingClientRect().top;
  const section6 =
    scroll + document.getElementById('section6').getBoundingClientRect().top;

  if (document.getElementById('section5') != null) {
    var section5 =
      scroll + document.getElementById('section5').getBoundingClientRect().top;
  }
...
if (document.getElementById('wishHeart') != null) {
  ...
  let productNo = document
    .querySelector('.detail--text__title')
    .getAttribute('data-productno');
...
function toggleModal() {
  faceModal.style.display =
    faceModal.style.display === 'block' ? 'none' : 'block';
}
...
document.querySelector('.detail--text__date-second').innerText =
  firstDate + ' - ' + lastDate;
