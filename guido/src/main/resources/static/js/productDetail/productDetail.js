...
window.addEventListener('scroll', () => {
  ...
  const section1 =
    scroll +
    document.getElementById('section1').getBoundingClientRect().top -
    120;
  const section2 =
    scroll +
    document.getElementById('section2').getBoundingClientRect().top -
    120;
  const section3 =
    scroll +
    document.getElementById('section3').getBoundingClientRect().top -
    120;
  const section4 =
    scroll +
    document.getElementById('section4').getBoundingClientRect().top -
    120;
  const section6 =
    scroll +
    document.getElementById('section6').getBoundingClientRect().top -
    120;

  if (document.getElementById('section5') != null) {
    var section5 =
      scroll +
      document.getElementById('section5').getBoundingClientRect().top -
      120;
  }
