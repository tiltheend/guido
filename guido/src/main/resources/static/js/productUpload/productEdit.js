...
const titleCharCheck = () => {
  const remainingChars = document.getElementById('inputTitle').value.length;
  titleCharCount.textContent = String(remainingChars);
  if (remainingChars > 75) {
    titleCountContainer.classList.add('red');
    document.getElementById('inputTitle').style.borderColor = 'red';
    document.getElementById('inputTitle').style.backgroundColor =
      'rgb(255,232,232)';
    nextBtn.disabled = true;
    ...
    document.getElementById('inputTitle').style.backgroundColor = '#b1d8da';
    titleWarning.style.display = 'none';
    document.getElementById('inputTitle').style.borderColor = 'black';
